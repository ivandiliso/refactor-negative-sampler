...
class OnMemoryDataset(Dataset):
    ...
    def _load_relation_domain_range(self) -> dict:
        ...
        return {self.relation_to_id[k]: v for k,v in data.items() if k in self.relation_to_id.keys()}